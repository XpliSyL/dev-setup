...
sudo scutil --set ComputerName "0x73794c"
sudo scutil --set HostName "0x73794c"
sudo scutil --set LocalHostName "0x73794c"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "0x73794c"
